...
public class ManagerServiceTest extends AbstractTest {
	...
	protected void template(final String user, final String username,
			final String password, final String passwordCheck,
			final String phone, final boolean termsOfUse, final String name,
			final String email, final String surName, final String vatNumber,
	...
	public void RegisterAManager() {
		...
		final Object testingData[][] = {
				...
				// administrador
				{ "admin", "manager1000", "manager1000", "manager1000",
						"+954670441", true, "manager1000",
						"manager1000@gmail.com", 
						"manager1000", "ESA12345678", "company",null },			
				// Intentar crear un manager logueandose en el sistema como chorbi
				{ "chorbi1", "manager1000", "manager1000", "manager1000",	
						"+954670441", true, "manager1000",					 
						"manager1000@gmail.com", 
						"manager1000", "ESA12345678", "company",DataIntegrityViolationException.class},			
				...
				{ "admin", "manager1000", "manager1000", "manager1000",		
					"+954670441", true, "manager1000",
					"manager1000@gmail.com", 
					"manager1000", "123456789", "company",DataIntegrityViolationException.class},
		...
		for (int i = 0; i < testingData.length; i++)
			this.template((String) testingData[i][0],
					...
					(boolean) testingData[i][5], (String) testingData[i][6],
